...
declare global {
  ...
  type ServerErrorType = 'FILE_REFERENCE_EXPIRED' | 'SESSION_REVOKED' | 'AUTH_KEY_DUPLICATED' |
    ...
    'MESSAGE_NOT_MODIFIED' | 'MESSAGE_EMPTY' | 'MESSAGE_ID_REQUIRED' | 'SLUG_INVALID' | `PREMIUM_SUB_ACTIVE_UNTIL_${number}` |
    ...
    'CHANNELS_TOO_MUCH' | 'BOOSTS_REQUIRED' | 'USERNAME_OCCUPIED' | 'AICOMPOSE_FLOOD_PREMIUM';
