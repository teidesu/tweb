...
import type { AddBotToChatScope } from '@/lib/appManagers/utils/bots/getBotAddToChatScope';
...
import hasBotAdminRights from '@/lib/appManagers/utils/bots/hasBotAdminRights';
