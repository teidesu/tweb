...
const CreateTonePopup = (inProps: CreateTonePopupProps) => {
  const props = mergeProps({
    titleLangKey: 'AiEditor.NewStyle.Title' as LangPackKey,
    submitLangKey: 'Create' as LangPackKey,
    errorLangKey: 'AiEditor.NewStyle.Error' as LangPackKey,
  }, inProps);
  ...
  const [docId, setDocId] = createSignal<DocId | undefined>(props.initialValues?.emojiId);
      ...
      <PopupElement.Body class={styles.popupBody}>
        <div class={/* @once */ styles.header}>
          <div class={styles.emojiButton} ref={setEmojiButton}>
            <div class={/* @once */ styles.emoji}>
              <Show when={docId()} fallback={<IconTsx icon='ai_style_tone' class={/* @once */ styles.emojiIcon} />} keyed>
                {(docId) =>
                  <EmojiDocumentIcon
                    docId={docId}
        ...
        <SimpleFormField.Section>
          ...
          >
            ...
            <SimpleFormField.InputStub>
              <Scrollable class={/* @once */ styles.inputFieldScrollable} relative>
        ...
        <div class={/* @once */ styles.checkboxContainer} onClick={() => setDisplayAuthor(p => !p)} use:ripple>
          <StaticCheckbox round checked={displayAuthor()} />
          <div class={/* @once */ styles.checkboxText}>
