...
export const StyleTab = () => {
  ...
  return (
    <div>
      <div class={/* @once */ styles.sectionWrapper}>
        <div class={/* @once */ styles.section}>
          <Transition name='fade-2' mode='outin'>
            <Show when={tonesResource.state === 'ready'} fallback={
              <Scrollable class={/* @once */ styles.tonesList} ref={setTonesListEl} axis='x' relative>
                <Show when={tonesResource.state === 'pending'}>
                  {[1, 2, 3, 4].map(() => (
                    <div class={/* @once */ styles.toneSkeleton}>
                      <Skeleton.Div class={/* @once */ styles.toneSkeletonIcon} secondary></Skeleton.Div>
                      <Skeleton.Div class={/* @once */ styles.toneSkeletonText} textLine secondary></Skeleton.Div>
                    </div>
                  ))}
                </Show>
              </Scrollable>
        ...
        {hasArrows && (
          <>
            <IconTsx
              class={clsx(styles.sectionArrow, styles.sectionArrowLeft)}
              classList={{
            ...
            />
            <IconTsx
              class={clsx(styles.sectionArrow, styles.sectionArrowRight)}
              classList={{
        ...
        <Show when={selectedToneAuthorId()}>
          {(authorId) => (
            <div style={{ overflow: 'hidden' }}>
              <div class={/* @once */ fieldSectionStyles.fieldSectionCaption}>
                <I18nTsx
