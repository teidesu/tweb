      ...
      <AutoHeight>
        <Transition name='fade-2' mode='outin'>
          <Show
            ...
            fallback={
              <div class={/* @once */ styles.comparisonContentSkeletonWrapper}>
                <Skeleton.Div secondary class={/* @once */ styles.comparisonContentSkeleton} />
              </div>
            }
            keyed
          >
            {(content) => (
              <Scrollable relative class={/* @once */ styles.comparisonContent}>
  ...
  return (
    <PopupElement class={tonePopupShellStyles.popup} containerClass={tonePopupShellStyles.popupContainer} show={show()}>
      ...
      <PopupElement.Body class={styles.popupBody}>
        <Show when={docId()} keyed>
          {(docId) => (
            <div class={/* @once */ styles.header}>
              <div class={/* @once */ styles.emojiButton}>
        ...
        <div class={/* @once */ styles.description}>
          <I18nTsx key="AiEditor.ViewStyle.Description" />
        </div>

        <Space amount='1rem' />

        <div class={/* @once */ styles.comparison}>
          <div class={/* @once */ styles.comparisonHeader}>
            <I18nTsx key="AiEditor.ViewStyle.Before" />
            <Transition name='fade-2'>
              <Show when={exampleNum() < maxNum()}>
                <div class={/* @once */ styles.anotherExampleButton} onClick={onAnotherExample} use:ripple>
                  <IconTsx icon="flip" />
          ...
          <Content />
          <div class={/* @once */ styles.comparisonDivider} />
          <div class={/* @once */ styles.comparisonHeader}>
