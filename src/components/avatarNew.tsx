...
async function loadAvatarVideoOverlay(
  ...
  const [url, videoStartTs] = await Promise.all([
    Promise.resolve(apiManagerProxy.loadAvatar(peerId, photo, videoSize)).catch((): string | undefined => undefined),
...
export const AvatarNew = (props: {
  ...
  let addedToQueue = false, lastRenderPromise: ReturnType<typeof _render> | undefined;
