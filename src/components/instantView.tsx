  ...
  return (
    <InstantViewContext.Provider value={props.value}>
      <div
        ...
        class={clsx(styles.InstantView, props.class, 'text-overflow-wrap')}
        onClick={onClick.bind(null, props.value)}
        style={props.style}
      >
        {props.value.customEmojiRenderer}
        <div class={clsx(styles.InstantViewContent, props.contentClass)}>
...
function Block(props: {
  ...
  switch (block._) {
    ...
    case 'pageBlockHeading2':
      return <h2 class={clsx(styles.Padding, styles.Subtitle)}><RichTextRenderer text={block.text} /></h2>;
    ...
    case 'pageBlockHeading5':
      return <h5 class={clsx(styles.Padding, styles.Subheader)}><RichTextRenderer text={block.text} /></h5>;
    case 'pageBlockHeading6':
      return <h6 class={clsx(styles.Padding, styles.Subheader)}><RichTextRenderer text={block.text} /></h6>;
    ...
    case 'pageBlockPreformatted': {
      ...
      if (block.language === 'math') {
        return (
          <div class={clsx(styles.Padding, styles.MathBlockWrapper)}>
      ...
      return <div class={clsx(styles.Padding, styles.PreformattedWrapper)}>{documentFragmentToNodes(fragment)}</div>;
    }
    case 'pageBlockMath':
    ...
    case 'pageBlockThinking':
      return (
        <p class={clsx(styles.Padding, styles.Paragraph, 'secondary')}>
          <RichTextRenderer text={block.text} />
        </p>
      );
